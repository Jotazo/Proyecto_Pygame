...
class TopLevelFrame:
    ...
    def __init__(self, config):
        ...
        self.lifes_count_font = pg.font.Font(self.settings.main_game_fonts['default'], 16)
        self.lifes_count_img = self.lifes_count_font.render(f'Lifes - 3', True, self.settings.colors['white'])

        self.score_count_font = pg.font.Font(self.settings.main_game_fonts['default'], 16)
        self.score_count_img = self.score_count_font.render(f'Score - 0', True, self.settings.colors['white'])

        self.dodged_meteors_font = pg.font.Font(self.settings.main_game_fonts['default'], 16)
